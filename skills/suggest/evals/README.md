...
"sí" runs `npx @damiangilgonzalez/harness add <id>`. It must never auto-install without confirmation and
must not recommend a skill already in `npx @damiangilgonzalez/harness list`.
