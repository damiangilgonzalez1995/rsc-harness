...
confirm: `npx @damiangilgonzalez/harness add <ids>`. Only if you genuinely cannot run a shell, hand the exact
...
3. **Skill audit.** Run `npx @damiangilgonzalez/harness audit`. It inventories what is installed here and on the
...
> (`01-TOOLS/` + `docs/`) leyendo todo lo que acabamos de decidir."
